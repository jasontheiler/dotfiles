  ...
  highlight_overrides = {
    mocha = function(palette)
      return {
        ...
        NoiceCmdlineIconCmdline = { fg = palette.flamingo, style = { "bold" } },
        NoiceCmdlineIconFilter = { fg = palette.flamingo, style = { "bold" } },
        NoiceCmdlineIconSearch = { fg = palette.flamingo, style = { "bold" } },
        NoiceCmdlinePopupBorder = { fg = palette.lavender },
        NoiceCmdlinePopupBorderSearch = { fg = palette.lavender },
        NoiceCmdlinePopupTitle = { fg = palette.lavender },
